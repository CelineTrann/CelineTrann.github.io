export const ProjectInfo = [{
    ...
    img: "/projects/direct-tweet.gif",
    imgAlt: "Home page of the Twitter clone",
},
{
    name: "Portfolio Website",
    description: "This is my portfolio website created to showcase my work experience and projects. It is used to showcase additional information that might not fit on my resume.",
