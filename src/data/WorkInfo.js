export const workInfo = [{
    ...
    img: "src/assets/workExperience/Alcumus.png", 
...
},
{
    ...
    img: "src/assets/workExperience/paramountCommerce.webp", 
...
},
{
    ...
    img: "src/assets/workExperience/TelusHealth.jpg", 
...
},
{
    ...
    img: "src/assets/workExperience/Ritual.png", 
...
},
{
    ...
    img: "src/assets/workExperience/ShopEdge.webp", 
    description: "At ShopEdge I maintained both the desktop application using .NET Framework, and the Android application using Java for a ERP software. I also created custom Crystal Reports and SSRS reports based on customer requirements. Additionally, I created and maintained stored procedures used in the applicaton using Microsoft SQL Server. ",
    techStack: [".NET Framework", "Android Studio", "Java", "Microsoft SQL Server", "SSRS Reports", "Crystal Reports"]
},
];